...
public class AvroSchemaConvert extends AbstractSchemaConvert {
    ...
    static {
        ...
        PRIMITIVE_TYPE_MAP.put(org.apache.avro.Schema.Type.FIXED, StandardSQLTypeName.BYTES);
        PRIMITIVE_TYPE_MAP.put(org.apache.avro.Schema.Type.STRING, StandardSQLTypeName.STRING);
        PRIMITIVE_TYPE_MAP.put(org.apache.avro.Schema.Type.BYTES, StandardSQLTypeName.BYTES);
        PRIMITIVE_TYPE_MAP.put(org.apache.avro.Schema.Type.INT, StandardSQLTypeName.INT64);
        PRIMITIVE_TYPE_MAP.put(org.apache.avro.Schema.Type.LONG, StandardSQLTypeName.INT64);
        PRIMITIVE_TYPE_MAP.put(org.apache.avro.Schema.Type.FLOAT, StandardSQLTypeName.FLOAT64);
        PRIMITIVE_TYPE_MAP.put(org.apache.avro.Schema.Type.DOUBLE, StandardSQLTypeName.FLOAT64);
        PRIMITIVE_TYPE_MAP.put(org.apache.avro.Schema.Type.BOOLEAN, StandardSQLTypeName.BOOL);
    }
    ...
    private Optional<Field.Builder> convertField(String fieldName,
        ...
        org.apache.avro.Schema finalSchema = schema;
    ...
    private Field.Builder convertRecord(String fieldName,
        ...
        for (org.apache.avro.Schema.Field avroField : avroFieldSchema.getFields()) {
